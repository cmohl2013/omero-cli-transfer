...
class TestTransfer(CLITest):
    ...
    def test_unpack(self, package_name):
        ...
        if package_name == "test/data/valid_single_image.tar":
            ...
            assert (
                len(
                    ezomero.get_map_annotation_ids(
                        self.gw, "Image", im_ids[-1]
                    )
                )
                == 3
        ...
        if package_name == "test/data/valid_single_dataset.zip":
            ...
            assert len(im_ids) == 1
            assert (
                len(ezomero.get_map_annotation_ids(self.gw, "Dataset", ds_id))
                == 1
            )
        ...
        if package_name == "test/data/valid_single_project.zip":
            ...
            assert len(im_ids) == 1
            assert (
                len(ezomero.get_map_annotation_ids(self.gw, "Project", pj_id))
                == 1
            )
            assert len(ezomero.get_tag_ids(self.gw, "Project", pj_id)) == 0
            self.delete_all()
