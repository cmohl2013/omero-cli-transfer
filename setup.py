...
arc_dependencies = ["pandas", "openpyxl"]
...
setup(
    ...
    description=(
        "A set of utilities for exporting a transfer"
    ...
    install_requires=["ezomero==2.0.0", "ome-types==0.4.2"],
    extras_require={
        "rocrate": ["rocrate==0.7.0"],
        "arc": arc_dependencies,
    },
    python_requires=">=3.8",
    cmdclass={"test": PyTest},
    tests_require=["pytest", "restview", "mox3"] + arc_dependencies,
)
